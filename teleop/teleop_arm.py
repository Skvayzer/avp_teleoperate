...
class VuerTeleop:
    ...
    def step(self):
        ...
        left_qpos = None #self.left_retargeting.retarget(left_hand_mat[tip_indices])[[4, 5, 6, 7, 10, 11, 8, 9, 0, 1, 2, 3]]
        right_qpos = None #self.right_retargeting.retarget(right_hand_mat[tip_indices])[[4, 5, 6, 7, 10, 11, 8, 9, 0, 1, 2, 3]]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--net", type=str, help="network interface", default="lo")
    ...
    try:
        ...
        if user_input.lower() == 's':
            while True:
                ...
                sol_q ,tau_ff, flag = arm_ik.ik_fun(left_pose, right_pose, armstate, None)
                if flag:
                    q_poseList[12:16] = sol_q[27:31]
                    q_poseList[16:20] = sol_q[10:14]
                    # q_tau_ff[12:16] = tau_ff[27:31]
                    # q_tau_ff[16:20] = tau_ff[10:14]
                else:
